...
@overload
def service(func: Callable[..., Any]) -> Callable[..., Any]:
...
def service(*args, **kwargs) -> Callable[..., Any]: ...
...
def event_trigger(*event_type: str, str_expr: str | None = None, **kwargs) -> Callable[..., Any]:
...
class task:
    ...
    def wait_until(
        ...
        webhook_methods: Iterable[str] = ('POST', 'PUT'),
        timeout: int | float | None = None,
